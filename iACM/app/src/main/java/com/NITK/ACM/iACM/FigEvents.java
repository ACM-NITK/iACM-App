...
public class FigEvents extends AppCompatActivity {

    private List<EventsList> eList = new ArrayList<> ();
    private RecyclerView recyclerView;

    private FigEventAdaptor eAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_fig_events);
        //
        Fig_homepage.currentActivity="Events";
        context=getApplicationContext ();
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view);
        dialog = new AlertDialog.Builder(this);
        eAdapter = new FigEventAdaptor (eList);
    ...
    void GetDataFireBase(int option){
        ...
        Log.v ("got it",databaseReference.getKey ());
